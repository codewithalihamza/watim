...
export const dict = {
  ...
  ar: {
    ...
    contactPage: {
      title: "لنتحدث.",
      sub: "أخبرنا أين تريد أن تصل، وسنوضح لك الطريق — وما إذا كانت وتم الشريك المناسب لهذه الرحلة. الحديث الأول دائمًا دون أي التزام.",
    ...
    quotePage: {
      ...
      submit: "ابدأ المحادثة عبر واتساب",
      submitHint: "سيتم فتح واتساب برسالة جاهزة بتفاصيل طلبك — أو",

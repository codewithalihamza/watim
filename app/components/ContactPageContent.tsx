        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {cards.map((c, i) => {
            const inner = (
              <Tilt
                max={5}
                className="flex h-full flex-col items-center rounded-3xl border border-white/10 bg-white/[0.03] p-7 text-center backdrop-blur-sm transition-colors hover:border-brand-teal/50"
              >
